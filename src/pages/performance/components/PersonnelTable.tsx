            ...
            <div className={"w-full overflow-x-auto"}>
                <table className={"w-full border-collapse"}>
                    ...
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M8 10l4-4 4 4" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                            strokeLinejoin="round"/>
                      <path d="M16 14l-4 4-4-4" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                            strokeLinejoin="round"/>
                    </svg>
                  </span>
                            </div>
                            ...
                            <tr key={row.id} className={"border-b border-gray-100 hover:bg-gray-50/60"}>
                                ...
                                <td className={"py-4 pr-3"}>
                                    <div className={"cursor-pointer flex items-center gap-3"}
                                         onClick={() => (activeTab === 1 ? navigate(`/user/${row.id}`) : navigate(`/user/supervisor/${row.id}`))}>
                                        <div className={"relative"}>
                                            <img src={row.initials} className={"h-9 w-9 rounded-full"} />
                                        </div>
                    ...
                    <span
                        className={"inline-flex items-center px-2 py-0.5 rounded-full bg-blue-50 text-blue-700 text-[11px] font-semibold"}>
                      {row.role}
                    </span>
                                </td>
                      ...
                      {devText}
                        ...
                        {isNegative && (
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none"
                                ...
                                <path d="M10 17h7v-7" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                                      strokeLinejoin="round"/>
                            </svg>
                        )}
                            ...
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none"
                                ...
                                <td className={"py-4 px-4 text-right"}>
                                    <div className={"flex flex-col items-end gap-2"}>
                                        <div className={"text-sm font-semibold text-gray-900"}>{percent.toFixed(1)}%
                                        </div>
